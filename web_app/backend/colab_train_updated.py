"""
Complete Training Script for Colab (Updated from Notebook)
包含从Colab notebook中提取的改进版本

Usage in Colab:
1. Upload training_data_interpretation_en.csv to Colab (or use create_test_data.py)
2. Run this script
"""
...
print("=" * 60)
print("\n⚠️ Make sure you have uploaded 'training_data_interpretation_en.csv' to Colab!\n")

# Start training with parameters from Colab notebook
# 注意：这是从Colab notebook中提取的参数设置
train_model(
    csv_path='training_data_interpretation_en.csv',
    output_dir='interpretation_model',
    num_epochs=3,  # Colab中测试用的参数
    batch_size=4,
    learning_rate=5e-5,
    max_length=128,  # Colab中为了节省内存用的参数
    warmup_steps=10
)
